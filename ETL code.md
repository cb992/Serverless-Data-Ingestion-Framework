...
.when(col("op_carrier") =="YV","Mesa Airline")
.when(col("op_carrier") =="YX","Republic Airways")
.when(col("op_carrier") =="AA","American Airlines")
.when(col("op_carrier") =="DL","Delta Airlines") 
.otherwise("") )
